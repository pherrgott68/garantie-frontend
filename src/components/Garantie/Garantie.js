...
import useSerie from "../Hooks/useSerial"
import Button from 'react-bootstrap/Button';
import Modal from 'react-bootstrap/Modal';
import 'bootstrap/dist/css/bootstrap.min.css';
import '../Garantie/Garantie.css'
import { CenterFocusWeak } from '@mui/icons-material';

const columns = [
	{ field: "id", headerName: "Code", width: 120, headerClassName: 'super-app-theme--header',sortable: true, hideable: false },
	{ field: "product_id", headerName: "Id Produit", width: 120, sheaderClassName: 'super-app-theme--header',ortable: true },
	{ field: "product", headerName: "Produit", width: 400,headerClassName: 'super-app-theme--header', sortable: true },
	{ field: "name", headerName: "Numéro de série", width: 200,headerClassName: 'super-app-theme--header', sortable: true },
];
...
const StyledRechField = styled(TextField)`
	margin: 10px 0;
	width: 200px;
`;


const RepositorySerial = () => {
	...
	const columns1 = [
		{ field: "id", headerName: "#", width: 120, sortable: true, hideable: false },
		{ field: "Modele", headerName: "Modèle", width: 250, sortable: true },
		{ field: "Serie", headerName: "Série", width: 200, sortable: true },
		{ field: "DateDebut", headerName: "Date début", width: 120, sortable: true },
	]

	const repositoryListSerial = useSerie();
